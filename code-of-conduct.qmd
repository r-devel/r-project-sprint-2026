...
Reports should be sent via a a direct message to the `moderators` group on the R Project Zulip (type `moderators` in the “Add users” dialog box - this will expand to show everyone in the moderators group, so you can exclude individuals if necessary). You can view the current [moderators](https://r-project.zulipchat.com/#groups/1729199/moderators/members) if you want to check who has access to this channel.\
\
